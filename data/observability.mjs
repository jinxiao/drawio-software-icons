...
export const observabilityProjects = [
  ...
  ['mimir','Grafana Mimir','official-apps','grafana/mimir',['mimir'],['grafana','LGTM','metrics','prometheus','指标','时序数据库']],
  ...
  ['victoriametrics','VictoriaMetrics','dashboard','VictoriaMetrics/VictoriaMetrics',['victoria metrics','vm'],['metrics','prometheus','time series','指标','时序数据库']],
...
export const observabilityMetadata = new Map([
  ...
  ['prometheus',{aliases:['普罗米修斯'],tags:['metrics','time series','指标','时序数据库']}],
