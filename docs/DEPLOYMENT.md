...
| --- | --- | --- | --- |
| `jinxiao.github.io/drawio-software-icons/` | `dist` | Software & brands | Software schema |
...
Cloud should be selected on the Alibaba site. Switch collections and languages,
...
上线后请打开两个旧网址，检查默认图标集、语言切换、Git / ECS 搜索和分类加载。
