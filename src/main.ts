...
const sourceName=(id:string)=>({devicon:'Devicon',dashboard:'Dashboard Icons',lobe:'Lobe Icons',antdesign:'Ant Design Icons',vendor:'Vendor Icons SVG','official-apps':messages[locale].officialPublisher} as Record<string,string>)[id]??id;
const symbols={
